...
contract PS {
    ...
    function verify(uint c, BN256G1.G1Point calldata ymink, uint s, BN256G1.G2Point calldata sigma1, BN256G1.G2Point calldata sigma2, bytes32 message) external returns (bool){
    ...
    function checkPairing(uint c, BN256G1.G1Point calldata ymink, uint s, BN256G1.G2Point calldata sigma1, BN256G1.G2Point calldata sigma2) public returns (bool){
    ...
    function checkHash(uint c, BN256G1.G2Point calldata sigma1, BN256G1.G2Point calldata sigma2, BN256G1.G1Point calldata ymink, bytes32 message) public returns (bool){
        ...
        bytes32 hashed2 = bytes32(uint(hashed) % BN256G1.NN);
        return (bytes32(c) == hashed2);
    }
