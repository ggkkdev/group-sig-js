...
contract PS {
    ...
    function checkHash(uint c, G2Point calldata sigma1, G2Point calldata sigma2, G1Point calldata ymink, bytes32 message) public returns (bool){
        ...
        //emit Debug(hashed);
        bytes32 hashed2 = bytes32(uint(hashed) % NN);
        //emit Debug(hashed2);
